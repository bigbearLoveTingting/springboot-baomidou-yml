...
// https://blog.csdn.net/qq1300375795/article/details/78368690
// 随机生成中文名、性别、手机号、住址、email的java代码

public class FakeTool {
	public static String base = "abcdefghijklmnopqrstuvwxyz0123456789";
    private static String[] firstName={ "赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
	...
	public static void main(String[] args) {
		for (int i = 0; i < 10000; i++) {
            System.out.println(getChineseName()+","+getMobile()+","+getEmail(6,9)+","+getRoad()+","+IdCardTool.gen(BirthdayTool.gen(), "1"));
        }
